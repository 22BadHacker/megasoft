...
const FAQ = () => {
  ...
  return (
    <div className='w-full grid grid-cols-1 lg:md:sm:px-4 py-4'>
        <p className='text-white text-[35px] font-bold pb-5'><span className='text-orangee'>* </span>FAQ <span className='font-medium text-[20px] text-green-400'>frequently asked questions</span></p>
                    ...
                    return (
                        <>
                            ...
                            <div key={i} className="flex flex-col w-full  py-2">
                                <button onClick={() => toggle(i)} className='flex justify-between items-center bg-[rgb(17,17,17,.9)] hover:bg-[rgb(17,17,17,.6)] text-white font-semibold w-full py-3 px-3  lg:md:sm:px-4 rounded-sm duration-300 ease-in-out'>
