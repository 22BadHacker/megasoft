        ...
        <div className='w-full z-[1] bg-gradient-to-r from-[rgb(17,17,17,.3)] to-[rgb(0,0,0,.3)] backdrop-blur-[20px] grid grid-cols-[1.5fr_1fr_1fr] relative h-auto '>
            ...
            <div className="flex gap-4 flex-col p-[20px_20px] col-span-1.5">
                ...
                <div className="flex flex-col gap-2  p-1">
                    {/* <h4 className='font-semibold    text-[14.5px]'>We’re not your average tech partner. </h4> */}
                    ...
                    <p className='text-white drop-shadow-[1px_1px_2px_rgb(255,255,255,.5)] text-[26px] font-bold pt-2'>We’re not your average tech partner.</p>
