...
const Services = () => {
  return (
    <div id='id' className='w-screen  bg-black pb-[200px] '>
      ...
      <div className="max-w-[1500px] px-4 md:lg:px-5 h-full mx-auto w-full">
        ...
        <div className=' w-full  pb-[60px] flex flex-col text-wrap md:lg:pb-[70px] pt-[100px]'>
                  ...
                  <h1  className='lg:text-[3vw] font-medium text-[20px] sm:text-[28px] sm:-top-[15px] relative lg:md:-top-8 opacity-85'>What <span className='text-orangee'>Services</span> We're Offering</h1> 
